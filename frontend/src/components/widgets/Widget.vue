  ...
  >
    ...
    >
      ...
      <button
        ...
        @click="closeWidget"
        :aria-label="$t('widgets.story.close')"
      >
      ...
      <div class="overflow-y-auto max-h-[85vh] scrollbar-thin scrollbar-thumb-antique-bronze/50 scrollbar-track-transparent font-body">
        ...
        <div v-else class="p-12 text-center">
          ...
          <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ t('widgets.fallback.unknown_type') }}</h3>
          <p class="text-gray-500">{{ t('widgets.fallback.type_id') }}: <span class="font-mono text-sm">{{ location.id_location_type }}</span></p>
        </div>
      </div>
    </div>
  </div>
