...
<template>
  <div class="py-12 bg-parchment">
        ...
        <div class="bg-white/40 backdrop-blur-sm rounded-sm shadow-lg p-8">
          ...
          <div class="mb-12 flex flex-col items-center">
            ...
            <div class="flex space-x-3">
              ...
              <label class="px-6 py-3 bg-stone-grey text-white rounded-sm hover:bg-iron-black transition-colors text-sm font-medium cursor-pointer shadow-md flex items-center">
    ...
    >
      <div
        class="bg-white/40 backdrop-blur-sm rounded-sm shadow-2xl max-w-4xl w-full mx-4 max-h-[80vh] overflow-hidden"
        @click.stop
      >
        ...
        <div class="flex justify-end p-6 border-t border-antique-bronze/20">
          <button
            class="px-6 py-2 bg-stone-grey text-white rounded-lg hover:bg-iron-black transition-colors"
            @click="closeAvatarModal"
          >
            Annuler
          </button>
