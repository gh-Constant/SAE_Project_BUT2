...
export const USER_QUESTS = [
  ...
  { id_user: 2, id_quest: 13, status: UserQuestStatus.COMPLETED, created_at: new Date('2024-01-21T09:00:00Z'), updated_at: new Date('2024-01-21T11:30:00Z'), quest: QUESTS[12] },
  { id_user: 2, id_quest: 14, status: UserQuestStatus.ACCEPTED, created_at: new Date('2024-01-22T06:00:00Z'), updated_at: new Date('2024-01-22T06:00:00Z'), quest: QUESTS[13] },
  ...
  { id_user: 3, id_quest: 11, status: UserQuestStatus.COMPLETED, created_at: new Date('2024-01-16T11:00:00Z'), updated_at: new Date('2024-01-16T13:00:00Z'), quest: QUESTS[10] },
