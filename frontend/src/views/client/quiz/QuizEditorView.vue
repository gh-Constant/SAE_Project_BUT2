          ...
          <div
            ...
            <div class="p-6 md:p-8 space-y-6">
              ...
              <div>
                ...
                <div class="relative">
                  <input v-model="quizData.title" type="text" required
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div class="relative">
                    <select v-model="quizData.id_location" required
                  ...
                  <div class="relative">
                    <div class="flex items-center gap-4">
                      ...
                      <div v-if="quizData.image_url"
                        ...
                        <button type="button" @click="quizData.image_url = ''"
              ...
              <div>
                ...
                <div class="prose prose-sm max-w-none">
                  <Editor v-model="quizData.description"
          ...
          <div class="space-y-6">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-4">
                ...
                <h2 class="font-medieval font-bold text-2xl text-iron-black">{{ $t('quiz.editor.questions_section') }}
                </h2>
              </div>
            ...
            <div v-else class="space-y-6">
              <QuizQuestionEditor v-for="(_, index) in quizData.questions" :key="index"
