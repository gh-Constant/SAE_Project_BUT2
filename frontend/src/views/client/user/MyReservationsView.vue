<template>
  <UserDashboardLayout>
    <div class="mb-8">
      <h1 class="text-3xl font-medieval font-bold text-iron-black mb-2">{{ t('reservations.title') }}</h1>
    ...
    <div v-else class="space-y-6">
      <div 
        ...
        class="bg-white/80 backdrop-blur-sm border border-antique-bronze/20 rounded-lg overflow-hidden shadow-md flex flex-col md:flex-row relative hover:shadow-lg transition-shadow"
      >
        <!-- Status Badge -->
