          ...
          <div class="flex flex-col md:flex-row justify-between items-start gap-6 mb-8">
            <div>
              ...
              <div class="flex items-center gap-4 text-stone-grey">
                ...
                <span v-if="event.event_category" class="inline-flex items-center px-2 py-1 rounded-full border border-antique-bronze/25 bg-antique-bronze/10 text-xs font-bold text-antique-bronze uppercase tracking-wide">
