              ...
              <table class="min-w-full divide-y divide-antique-bronze/10">
                <thead class="bg-antique-bronze/10">
                  <tr>
                    <th scope="col"
                      ...
                      {{ t('prestataire.products.table.headers.image') }}</th>
                    <th scope="col"
                      class="px-6 py-4 text-left text-xs font-medieval font-bold text-iron-black uppercase tracking-wider">
                      {{ t('prestataire.products.table.headers.name') }}</th>
                    <th scope="col"
                      class="px-6 py-4 text-left text-xs font-medieval font-bold text-iron-black uppercase tracking-wider">
                      {{ t('prestataire.products.table.headers.description') }}</th>
                    <th scope="col"
                      class="px-6 py-4 text-center text-xs font-medieval font-bold text-iron-black uppercase tracking-wider">
                      {{ t('prestataire.products.table.headers.price') }}</th>
                    <th scope="col"
                      class="px-6 py-4 text-center text-xs font-medieval font-bold text-iron-black uppercase tracking-wider">
                      {{ t('prestataire.products.table.headers.stock') }}</th>
                    <th scope="col"
                      class="px-6 py-4 text-center text-xs font-medieval font-bold text-iron-black uppercase tracking-wider">
                      {{ t('prestataire.products.table.headers.actions') }}</th>
                  </tr>
                </thead>
                <tbody class="divide-y divide-antique-bronze/10 font-body">
                  <tr v-for="product in productsByLocation(location.id)" :key="product.id"
                    ...
                    <td class="px-6 py-4">
                      <div v-if="store.editId !== product.id" class="text-sm font-bold text-iron-black">{{ product.name
                      }}</div>
                  ...
                  <tr v-if="productsByLocation(location.id).length === 0">
                    <td colspan="6" class="px-6 py-16 text-center bg-white/40">
                      <div class="flex flex-col items-center">
                        ...
                        <p class="text-sm text-stone-grey mt-1 font-body">{{ t('prestataire.products.empty.subtitle') }}
                        </p>
                      </div>
                    </td>
                  </tr>
