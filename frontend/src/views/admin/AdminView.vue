          ...
          >
            ...
            <div class="relative p-6">
              <div class="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h2 class="text-2xl font-medieval font-bold text-iron-black">{{ t('admin.dashboard.categories.events.title') }}</h2>
                  <p class="text-sm text-stone-grey">{{ t('admin.dashboard.categories.events.subtitle') }}</p>
                </div>
              </div>
              ...
              <div class="space-y-3">
                ...
                >
                  <span class="flex items-center gap-3">
                    <i class="fas fa-tasks text-antique-bronze"></i>
                    <span class="font-medieval font-bold text-iron-black">{{ t('admin.dashboard.categories.events.manage') }}</span>
                  </span>
                  <i
                    class="fas fa-arrow-right text-antique-bronze opacity-0 group-hover/btn:opacity-100 group-hover/btn:translate-x-1 transition-all"
                  ></i>
          ...
          >
            ...
            <div class="relative p-6">
              ...
              <div class="space-y-3">
                ...
                <router-link
                  to="/admin/locations/stats"
                  class="flex items-center justify-between px-4 py-3 bg-white/50 hover:bg-white/80 border border-antique-bronze/20 rounded-lg transition-all duration-300 group/btn w-full"
                >
                  <span class="flex items-center gap-3">
                    <i class="fas fa-globe-europe text-antique-bronze group-hover/btn:scale-110 transition-transform duration-300"></i>
                    <span class="font-medieval font-bold text-iron-black">{{ t('admin.dashboard.categories.locations.stats') }}</span>
                  </span>
                  <i
                    class="fas fa-arrow-right text-antique-bronze opacity-0 group-hover/btn:opacity-100 group-hover/btn:translate-x-1 transition-all"
                  ></i>
