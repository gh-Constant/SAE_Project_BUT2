<template>
  <div class="min-h-full flex flex-col md:flex-row">
    ...
    <!-- Right form -->
    <div class="flex-1 md:w-1/2 bg-gray-50 flex flex-col justify-center p-8">
      <div class="w-full max-w-md mx-auto">

        <!-- Welcome Text -->
        <div class="mb-12 text-left">
          <h1 class="mb-3 text-5xl font-extrabold text-gray-900 tracking-tight" style="text-shadow: 3px 3px 6px rgba(0,0,0,0.15);">
            Welcome Back
          </h1>
          <p class="text-3xl font-bold bg-gradient-to-r from-orange-600 to-orange-500 bg-clip-text text-transparent">
            Enter your details to login
          </p>
        </div>

        <!-- Error Message -->
        <div v-if="errorMessage" class="mb-4 p-4 bg-red-500 text-white rounded-lg shadow-md flex justify-between items-center">
        ...
        <form @submit.prevent="handleLogin" class="space-y-6">
          ...
          <div class="flex items-center justify-between">
            ...
            <button type="button" class="text-sm text-orange-500 hover:text-orange-600 font-medium">Need help?</button>
          </div>
