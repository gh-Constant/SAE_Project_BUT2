...
CREATE TABLE `prestataires` (
    ...
    INDEX `prestataires_id_prestataire_type_idx`(`id_prestataire_type`),
    PRIMARY KEY (`id_user`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `qr_sessions` (
    ...
    `status` ENUM('PENDING', 'SCANNED', 'USED') NOT NULL DEFAULT 'PENDING',
    `data` JSON NULL,
    ...
    UNIQUE INDEX `qr_sessions_token_key`(`token`),
    INDEX `qr_sessions_token_idx`(`token`),
    INDEX `qr_sessions_created_by_id_idx`(`created_by_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `services` (
    ...
    INDEX `services_id_prestataire_idx`(`id_prestataire`),
    INDEX `services_id_service_type_idx`(`id_service_type`),
    INDEX `services_id_location_idx`(`id_location`),
...
-- AddForeignKey
ALTER TABLE `prestataires` ADD CONSTRAINT `prestataires_id_user_fkey` FOREIGN KEY (`id_user`) REFERENCES `users`(`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `prestataires` ADD CONSTRAINT `prestataires_id_prestataire_type_fkey` FOREIGN KEY (`id_prestataire_type`) REFERENCES `prestataire_types`(`id_prestataire_type`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `qr_sessions` ADD CONSTRAINT `qr_sessions_created_by_id_fkey` FOREIGN KEY (`created_by_id`) REFERENCES `users`(`id_user`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `qr_sessions` ADD CONSTRAINT `qr_sessions_scanned_by_id_fkey` FOREIGN KEY (`scanned_by_id`) REFERENCES `users`(`id_user`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `locations` ADD CONSTRAINT `locations_id_prestataire_fkey` FOREIGN KEY (`id_prestataire`) REFERENCES `prestataires`(`id_user`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `services` ADD CONSTRAINT `services_id_prestataire_fkey` FOREIGN KEY (`id_prestataire`) REFERENCES `prestataires`(`id_user`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `services` ADD CONSTRAINT `services_id_service_type_fkey` FOREIGN KEY (`id_service_type`) REFERENCES `service_types`(`id_service_type`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `services` ADD CONSTRAINT `services_id_location_fkey` FOREIGN KEY (`id_location`) REFERENCES `locations`(`id_location`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `products` ADD CONSTRAINT `products_id_prestataire_fkey` FOREIGN KEY (`id_prestataire`) REFERENCES `prestataires`(`id_user`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `stock` ADD CONSTRAINT `stock_id_service_fkey` FOREIGN KEY (`id_service`) REFERENCES `services`(`id_service`) ON DELETE RESTRICT ON UPDATE CASCADE;
